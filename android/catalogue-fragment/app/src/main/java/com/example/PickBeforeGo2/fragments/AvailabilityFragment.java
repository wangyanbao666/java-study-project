...
public class AvailabilityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Boolean stock = intent.getBooleanExtra("stock",true);
        View availability = null;
        if (stock){
            availability = inflater.inflate(R.layout.fragment_availability,container,false);
        }
        else{
            availability = inflater.inflate(R.layout.fragment_availability_no_stock,container,false);
        }
        return availability;
    }
}